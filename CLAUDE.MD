...
- Use parallel agents whenever it makes sense to speed up the process, save main agent context window, but don't deploy 10 agents for 2 small todos in the code base (you know what im saying)
